        ...
        <div className="onboarding-screen">
            ...
            <div className="onboarding-content">
                ...
                <ul className="onboarding-list">
                    ...
                    <li><strong>Дезертирство:</strong> Закрыл приложение во время таймера? Штраф -15%.</li>
                    <li><strong>Блокировка:</strong> Уронишь рейтинг ниже 50% — я заблокирую тебе управление.</li>
                </ul>
            ...
            <div className="give-up-modal" style={{ maxHeight: '80vh', overflowY: 'auto' }}>
                ...
                <div className="onboarding-text" style={{textAlign: 'left', marginTop: '15px'}}>
                    ...
                    <ul className="onboarding-list" style={{borderLeftColor: 'var(--border-color)', margin: '15px 0'}}>
                        <li><strong>Кредит доверия:</strong> Старт со 100%. Выполняешь задачи в срок — получаешь +1%.</li>
                        <li><strong>Сдача:</strong> Отмена таймера фокуса снимает -5%.</li>
                        <li><strong>Дезертирство:</strong> Закрытие приложения во время работы таймера — это побег. Штраф -15%.</li>
                        <li><strong>Штраф за ложь:</strong> Игнорирование задачи в течение дня снижает доверие на -1%.</li>
                        <li><strong>Локаут:</strong> Рейтинг ниже 50% блокирует право редактировать или удалять цели.</li>
                    </ul>
                </div>
                <button className="btn-continue-pulsing" onClick={() => { 
