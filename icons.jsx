// ==========================================
// ФАЙЛ: icons.jsx
// Описание: Векторная графика и Сущность ИИ
// ==========================================

// 1. Абстрактный Векторный Судья (Сущность)
...
// 2. Библиотека всех интерфейсных иконок
const Icons = {
...
// 3. Жесткая привязка к Window (чтобы другие файлы их видели)
window.EntityIcon = EntityIcon;
window.Icons = Icons;